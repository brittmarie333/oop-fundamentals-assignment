...
#- Expected Outcome: Completion of the Vehicle class with the update_ownermethod and
# a demonstration script showing the creation of Vehicle objects and updating their owners.

    def update_owner(self, new_owner):
        self.owner = new_owner
        print(f"Owner of vehicle {self.registration_number} has been update to {sel}")