...
print(f"Red Vehicle Registration: {redvehicle.registration_number}, Type: {redvehicle.type}, Owner: {bluevehicle.owner}")

print(f"Blue Vehicle Registration: {bluevehicle.registration_number}, Type: {bluevehicle.type}, Owner: {bluevehicle.owner}")
...
print(f"Updated Blue Vehicle \nRegistration: {bluevehicle.registration_number}, Type: {bluevehicle.type}, Owner: {bluevehicle.owner}")
